...
mediaType:1,
mediaUrl: 'https://chat.whatsapp.com/F4dGv48uhUc0pQoZb58jiB',
sourceUrl: "https://chat.whatsapp.com/F4dGv48uhUc0pQoZb58jiB"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
	                let btn = [{
                                urlButton: {
                                    displayText: 'YouTube khufu🍒',
                                    url: `${websitex}`
                                }
                            }, {
                                callButton: {
                                    displayText: 'YouTube ozx🍒',
                                    url: `${botscript}`
                                }
                            }, {
                                quickReplyButton: {
                        ...
                        let buttonmenu = [
        	{ urlButton: { displayText: `YouTube khufu🍒`, url : `${websitex}` } },
            { urlButton: { displayText: `YouTube ozx🍒`, url: `${botscript}` } },
...
╠ ${prefix}request
╠ ${prefix}report [bug]
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube khufu😜","url": `${websitex}`}},{"urlButton": {"displayText": "YouTube ozx🍒","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
break
case 'ownermenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
